-- Floating/Bobbing Script for lowercase l
-- Protocol: Node
...
local PROPERTY_NAME = "boby_l"  -- Hardcoded for lowercase l (note: matches your ViewModel property name)
local PHASE_OFFSET = 0.55       -- Hardcoded phase offset
