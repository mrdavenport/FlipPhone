-- Session to Badge Shape Converter
...
-- Output: DataValueNumber (badgeShapeValue: 10-50 for minutes, 100-2400 for hours)
--
...
local thresholds: { BadgeRow } = {
    { upper = 600, badge = 5 },       -- 5m:   300-599 (streak achieved)
