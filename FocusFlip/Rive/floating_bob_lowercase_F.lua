-- Floating/Bobbing Script for lowercase F
-- Protocol: Node
...
local PROPERTY_NAME = "boby_F"  -- Hardcoded for lowercase F (note: matches your ViewModel property name)
local PHASE_OFFSET = 0.0         -- Hardcoded phase offset
